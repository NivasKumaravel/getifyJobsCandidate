...
class UpdateMobile_Otp_Verification_Page extends ConsumerStatefulWidget {
  final String? mobileNumber;

  UpdateMobile_Otp_Verification_Page(
      {super.key, required this.mobileNumber});

  @override
  ConsumerState<UpdateMobile_Otp_Verification_Page> createState() =>
      _Otp_Verification_PageState();
}

class _Otp_Verification_PageState extends ConsumerState<UpdateMobile_Otp_Verification_Page> {
